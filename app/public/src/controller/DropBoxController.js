class DropBoxController {
    ...
    connecFirebase(){
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyB0xeGUT6bZaQFdbVgwA_OSipsCszrg-58",
            authDomain: "dropbox-clone-1c943.firebaseapp.com",
            databaseURL: "https://dropbox-clone-1c943-default-rtdb.europe-west1.firebasedatabase.app",
            projectId: "dropbox-clone-1c943",
            storageBucket: "dropbox-clone-1c943.appspot.com",
            messagingSenderId: "968376529951",
            appId: "1:968376529951:web:9c76d383db1acd443c112a"
        };
        // Initialize Firebase
    ...
    initEvents() {
        ...
        this.btnSendFileEl.addEventListener('click', event => {
            ...
            //Abrindo tela para selecionar aquivos;
    ...
    //Metodo para controlar a visibilidade da barra de progresso de upload dos arquivos;
    modalShow(show = true) {
    ...
    //Metodo para calcular o tempo estimado para fazer upload dos arquivos;
    ...
    //Formatando tempo estimado para aparecer na barra de progresso do upload;
    ...
    //Selecionando o icone de acordo com o modelo do arquivo;
